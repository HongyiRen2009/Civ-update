...
const popups = [
    {
        ...
        choosetext() {
            if (
                resources <
                difficulty ** 3 / 200 - (difficulty ** 3 / 200) * (techstats.diplomacy + 1)
            ) {
            ...
            this.power = Math.floor(
                difficultymultiplier *
                    ((getRandomInt(m.spy, 3) ? 1 : 0.5) *
                        (difficulty ** 2.9 / 64) *
                        (getRandomInt(8, 12) / 10))
            );
            this.description = `A neighbouring tribe is raiding your village${
                techstats.scouting ? `<br><br>Scouting Estimate: ${this.power}` : ''
            }`;
        },
        choices: [
            {
            ...
            },
            {
                ...
                effect() {
                    ...
                    const amountremove = Math.max(
                        resources / 2 + (resources / 2) * (techstats.diplomacy + 1),
                        difficulty ** 3 / 200 - (difficulty ** 3 / 200) * (techstats.diplomacy + 1)
                    );
...

    {
        ...
        choices: [
            ...
            },
            {
                text: 'Bribe',
                effect() {
                    information[2].choosetext(
                        Math.floor((difficulty ** 2.7 / 50) * (techstats.diplomacy + 1))
                    );
    ...
    },
    {
        ...
        size: '30px',
        description:
            'The neighboring tribe looks weak, do we enslave his people or steal their resources',
        choices: [
            {
                text: 'Enslave',
                effect() {
    ...
    },
    {
        ...
        size: '30px',
        description:
            'A faraway traveler stumbles into your village. He claims that a deadly plague wiped out his village and is spreading to yours. Should we lockdown or not',
        choosetext() {},
        choices: [
            {
                text: 'Lockdown',
    ...
    },
    {
        ...
        size: '30px',
        description:
            "Seasonal droughts destroyed your food production. <strong class = 'color-r'>-20% food production</strong>",
        choosetext() {},
        choices: [
            {
                text: 'close',
    ...
    },
    {
        ...
        size: '25px',
        description:
            'A man wearing a silly green hat and a bow strung on his back arrives to your village. He claims that he is Robin Hood steals from the rich and gives to the poor. He asks us for some resources and in exchange we will receive a great prize. Do we trust him?',
        choosetext() {},
        choices: [
            {
                text: 'not',
            ...
            },
            {
                text: 'give',
                effect() {
                    if (achievements[22].acquired == false) {
    ...
    },
    {
        ...
        size: '25px',
        description:
            'A wildfire burnt down a large portion of your village, should we rebuild the burnt buildings?',
        choosetext() {
            choices = [
...

    {
        ...
        choosetext() {
            ...
            this.description = `A group of ${shorten(
                Math.round(currentpop * 0.5)
            )} people stumble into your village. They claim that they are refugees from a distant war and are seeking refuge. Your advisers predict that it'll take ${
                this.time
            } years for them to adapt to our village. Do we let them in or not?`;
        ...
        choices: [
            {
                ...
                effect() {
                    ...
                    temporaryeffects.push({
                        type: 'add',
                        resources: 0,
                        unemployed: Math.round(currentpop * 0.25) * -1,
                        military: 0,
                        food: 0,
                        duration: this.time,
                    });
    ...
    },
    {
        ...
        choosetext() {
            choice = ['better weapons', 'tougher hoes', 'stronger pickaxes'];
            random = getRandomInt(0, 2);
    ...
    },
    {
        ...
        size: '30px',
        description:
            'Our scout reports that opportunities for new trade routes have arisen. The Rateddians request. Thersialymoa. Menloms ',

        choosetext() {
            const upsides = [
                {
                    name: 'food',
                    info: 'food production',
                    trade() {
                        modifiers.food += 3;
                    },
                },
    ...
    },
    {
        ...
        size: '25px',
        description:
            "A distant roar echos across the mountains, followed by thunderous flaps. An ancient creature has awoken, prepare your village and your army<br><strong class = 'color-r'>they won't last long.</strong>",
        choosetext() {},
        choices: [
            {
                text: 'fight!',
    ...
    },
    {
        ...
        size: '25px',
        description:
            'Deafening sounds shockwave across your village. Piles of ash and lava pour down the hills, annihilating everything in its way, while debris launched into the air squash housing like cockroaches.',
        choosetext() {},
        choices: [
            {
                text: 'close',
        ...
        choices: [
            ...
            },
            {
                ...
                effect() {
                    if (
                        military >=
                        (getRandomInt(6, 14) / 10) * difficultymultiplier * (difficulty ** 3.2 / 9)
                    ) {
    ...
    },
    {
        ...
        choosetext() {
            const choice = [
                `pay them a tribute of ${shorten(
                    Math.floor(difficulty ** 3 / 600)
                )} resources a year<br> for 10 years`,
        ...
        choices: [
            {
                ...
                effect() {
                    const enemymilitary =
                        (getRandomInt(8, 12) / 10) * difficultymultiplier * (difficulty ** 3.2 / 3);
                    wars.push({
                        power: enemymilitary,
                        totalpower: enemymilitary,
                        divine: false,
                    });
                ...
                effect() {
                    switch (this.index) {
                        case 0:
                            temporaryeffects.push({
                                type: 'add',
                                resources: Math.floor(difficulty ** 3 / 200) * -1,
                                unemployed: 0,
                                military: 0,
                                food: 0,
                                duration: 10,
    ...
    },
    {
        ...
        size: '25px',
        description:
            'Your scouts claims that the enemy is attacking, but with unknown power. What percentage of your army should you commit?',
        choosetext() {
            let enemypower = 0;
            for (i = 0, len = wars.length; i < len; i++) {
                if (wars[i].power > 0) {
                    enemypower += Math.max(
                        (wars[i].power * getRandomInt(30, 80)) / 100,
                        Math.min(wars[i].power, wars[i].totalpower / 7)
                    );
                }
            }
            ...
            if (techstats.scouting) {
                this.description = `Your scouts claims that the enemy is attacking. What percentage of your army should you commit?<br>Scouting Estimate: ${shorten(
                    Math.floor(enemypower * (getRandomInt(5, 15) / 10))
                )}`;
            } else {
                this.description =
                    'Your scouts claims that the enemy is attacking, but with unknown power. What percentage of your army should you commit?';
        ...
        choices: [
            ...
            },
            {
                ...
                effect() {
                    if (getRandomInt(0, 3) == 0) {
                        information[43].choosetext(
                            Math.floor((m_personnel + unemployed) / 8),
                            Math.floor(m_personnel / 4)
                        );
                        displaypopup(43, information);
                        currentpop -= Math.floor((m_personnel + unemployed) / 4);
                    } else if (military * 0.25 > this.power) {
                        for (const war of wars) {
                            if (war.power > 0) {
                                war.power -= Math.floor(this.power / 1.5);
                            }
                        }
                        information[44].choosetext(
            ...
            },
            {
                ...
                effect() {
                    if (getRandomInt(0, 3) == 0) {
                        information[43].choosetext(
                            Math.floor((m_personnel + unemployed) / 4),
                            Math.floor(m_personnel / 2)
                        );
                        displaypopup(43, information);
                        currentpop -= Math.floor((m_personnel + unemployed) / 4);
                    } else if (military * 0.5 > this.power) {
                        for (const war of wars) {
                            if (war.power > 0) {
                                war.power -= Math.floor(this.power / 1.5);
                            }
            ...
            },
            {
                ...
                effect() {
                    if (getRandomInt(0, 3) == 0) {
                        information[43].choosetext(
                            Math.floor((m_personnel + unemployed) / 4),
                            Math.floor(m_personnel)
                        );
                        displaypopup(43, information);
                        currentpop -= Math.floor((m_personnel + unemployed) / 4);
                    } else if (military * 0.75 > this.power) {
                        for (const war of wars) {
                            if (war.power > 0) {
                                war.power -= Math.floor(this.power / 1.5);
                            }
                        ...
                        information[0].choosetext(
                            Math.floor((m_personnel + unemployed) / 3),
                            Math.floor(m_personnel)
                        );
            ...
            },
            {
                ...
                effect() {
                    if (getRandomInt(0, 3) == 0) {
                        information[43].choosetext(
                            Math.floor((m_personnel + unemployed) / 2),
                            Math.floor(m_personnel * 2)
                        );
                        displaypopup(43, information);
        ...
        choices: [
            {
                ...
                effect() {
                    ...
                    if (military > wars[random_war].power * randomm) {
                        ...
                        information[44].choosetext(
                            Math.floor(wars[random_war].power * randomm * 3),
                            Math.floor(m_personnel / 2)
                        );
                        ...
                        information[0].choosetext(
                            Math.floor((m_personnel + unemployed) / 2) + casual,
                            Math.floor(m_personnel / 2)
                        );
                        displaypopup(0, information);
                    }
...

    {
        ...
        size: '25px',
        description:
            "Your scouts claims that the enemy's defenses are down. What percentage of your army should you commit to the attack?",
        choosetext() {
            let enemypower = 0;
            for (i = 0, len = wars.length; i < len; i++) {
                if (wars[i].power > 0) {
            ...
            if (techstats.scouting) {
                this.description = `Your scouts claims that the enemy's defenses are down. What percentage of your army should you commit to the attack?<br>Scouting Estimate: ${shorten(
                    Math.floor(enemypower * (getRandomInt(6, 14) / 10))
                )}`;
            } else {
                this.description =
                    "Your scouts claims that the enemy's defenses are down. What percentage of your army should you commit to the attack?";
            ...
            },
            {
                ...
                effect() {
                    if (getRandomInt(0, 3) == 0) {
                        ...
                        information[47].choosetext(
                            Math.floor(this.power * 3),
                            Math.floor(m_personnel / 4)
                        );
    ...
    },
    {
        ...
        choosetext() {
            ...
            if (power > military) {
                this.description = `A courier of peace enters our village with a peace offer. If we pay them a tribute of <strong class = 'color-r'>${shorten(
                    Math.floor((100 * power) / military)
                )}</strong> resources a year for 10 years, they'll make peace. Do we accept their offer?`;
                this.choices[0].resourceamount = Math.floor((100 * power) / military) * -1;
            } else {
                this.description = `A courier of peace enters our village with a peace offer. If they pay us a tribute of <strong class = 'color-g'>${shorten(
                    Math.floor((100 * military) / power)
                )}</strong> resources a year for 10 years, we'll make peace. Do we accept their offer?`;
    ...
    },
    {
        ...
        size: '30px',
        description:
            'After years of trials and tribulation, you finally constructed the ultimate megastructure, the Mega Temple. As god decends from the heavens, he blesses you and your followers with infinite power. As you ascend to the heavens, leaving the mortal realm, you quickly glance back at your thriving city, which would leave its mark on history forever.',
...

    {
        ...
        choosetext(reason) {
            switch (reason) {
                case 'pop':
                    this.description =
                        "Your village lays deserted as all of the inhabitants have either abandoned it or have died. As you survey the ruins that could have been your kingdom, you realize what this village has become; a ghost town, it's only inhabitants being thieves and wild animals.";
                    break;
                case 'res':
                    this.description =
                        'Your inhabitants grew restless, hearing about your failures to provide resources for them, and rose up against you and the last of your followers. They stormed your home and left you to die.In your last waking moments, you realize what you lost, what you are; a dying shell of your former self.';
                    break;
                case 'food':
                    this.description =
                        'As your people starved, they began to question your rule. Because of your faliure to produce food for your citizens,they rose up against you and you were humiliatingly dethroned. you walk out of the village exiled,knowing that you were the reason for your faliure, a hopless, homeless faliure.';
                    break;
            }
        },
        choices: [
...
const information = [
    {
        ...
        choosetext(poplost, ePopLost, civLost) {
            this.description = `You were unable to repel the raiders <br>Casualties: <strong class = 'color-r'>${shorten(
                poplost + civLost
            )} (${civLost} civilian)</strong><br>Enemy Casualties: <strong class = 'color-g'>${shorten(
                ePopLost
            )}</strong>`;
            this.choices[0].casualties = poplost + civLost;
        },
        choices: [
            {
                casualties: 0,
    ...
    },
    {
        ...
        choosetext(amount, ePopLost, civLost) {
            ...
            this.choices[0].casualties = amount + civLost;
        },
        choices: [
            {
                casualties: 0,
    ...
    },
    {
        ...
        size: '30px',
        description:
            "You decimated their village and stole their resources. <strong class = 'color-g'>+33% resources</strong>",
        choosetext(amount) {
    ...
    },
    {
        ...
        size: '30px',
        description:
            "You decimated their village and enslaved their people.<strong class = 'color-g'> +33% population</strong>",
        choosetext(amount) {
    ...
    },
    {
        ...
        size: '30px',
        description:
            "He thanked you and walked off, next thing you know, your archer's accuracy improved greatly. <strong class = 'color-g'>+40% military</strong>, <strong class = 'color-r'>-40% resources</strong>",
        choosetext(amount) {
    ...
    },
    {
        ...
        size: '30px',
        description:
            "He thanked you and ran off, next thing you know, he's selling all of the resources for his own gain. -40% resources",
        choosetext(amount) {
    ...
    },
    {
        ...
        size: '30px',
        description:
            "He scoffed at you and ran off, next thing you know, he's out to murder countless civilians. -20% population",
        choosetext(amount) {
    ...
    },
    {
        ...
        choosetext(amount) {
            this.description = `We decided to be nice and let the refugees in. <strong class = 'color-g'>+${shorten(
                amount
            )} population</strong>`;
        },
        choices: [
    ...
    },
    {
        ...
        description:
            "We told them that we don't have enough room in our village and that they can't come.",
    ...
    },
    {
        ...
        description:
            'We told him deal and gave him our resources. Moments later he came back with powerful weapons. -33% resources, +50% military',
        choosetext: function (which, amount) {
            switch (which) {
                case 0:
                    this.description =
                        "We told him deal and gave him our resources. Moments later he came back with powerful weapons. <strong class = 'color-r'>-${amount} resources</strong>,<strong class = 'color-g'> +50% military</strong>";
                    break;
                case 1:
                    this.description =
                        "We told him deal and gave him our resources. Moments later he came back with shiny new hoes. <strong class = 'color-r'>-${amount} resources</strong>, <strong class = 'color-g'>+50% food production</strong>";
                    break;
                case 2:
                    this.description =
                        "We told him deal and gave him our resources. Moments later he came back with stronger pickaxes. <strong class = 'color-r'>-${amount} resources</strong>, <strong class = 'color-g'>+50% resource production</strong>";
                    break;
            }
        },
        choices: [
    ...
    },
    {
        ...
        choosetext(amount) {
            ...
            this.description = `After sending your army to fight, you hear reports that they <strong class = 'color-r'>${
                choice[getRandomInt(0, 3)]
            }.<br> Casualties: ${shorten(amount)}</strong>`;
        },
    ...
    },
    {
        ...
        choosetext(enemy, resource) {
            this.description = `You defeated the enemy army.<br>Enemy casualties: <strong class = 'color-g'>${shorten(
                Math.floor(enemy / 3)
            )}</strong><br>Enemies captured: <strong class = 'color-g'>${shorten(
                Math.floor(enemy / 5)
            )}</strong><br>Resources spent: <strong class = 'color-r'>${shorten(
                resource
            )}</strong>`;
        },
        description: `The enemy wasn't present`,
    ...
    },
    {
        ...
        choosetext(enemy, resources) {
            this.description = `You overcame their defenses and devestated their village<br>Enemy casualties: <strong class = 'color-g'>${shorten(
                Math.floor(enemy / 3)
            )}</strong><br>Enemies captured: <strong class = 'color-g'>${shorten(
                Math.floor(enemy / 5)
            )}</strong><br>Resources spent: <strong class = 'color-r'>${shorten(
    ...
    },
    {
        ...
        choosetext() {
            const amountr = Math.floor(
                difficulty ** 3 / 10 + (resources < 0 ? Math.abs(resources) / 2 : 0)
            );
...
const inputs = [
    {
        title: "<strong class = 'color-g'>New Army Group</strong>",
        size: '30px',
        description: `What do you want to name your new army group?`,
        choosetext(divisionGroupsContainer) {
            this.choices[0].divisionGroupsContainer = divisionGroupsContainer;
        },
        choices: [
            {
                text: 'confirm',
                effect() {
                    armyGroups.push(document.getElementById('popupInput').value);
                    document.getElementById('popup_block_buttons').style.display = 'none';
                    document.getElementById('popup').style.display = 'none';
                    const divisionGroup = document.createElement('OPTION');
                    divisionGroup.innerHTML = armyGroups[armyGroups.length - 1];
                    divisionGroup.textAlign = 'center';
                    for (const DGC of document.getElementsByClassName('divisionGroup')) {
                        DGC.insertBefore(
                            divisionGroup.cloneNode(true),
                            DGC.childNodes[DGC.childNodes.length - 1]
                        );
                    }
                    this.divisionGroupsContainer.value = armyGroups[armyGroups.length - 1];
                },
            },
            {
                text: 'cancel',
...
function displaypopup(index, list = popups, dt = 50, dl = 50, disable = true, input = false) {
    ispainting = false;
    if (disable) {
    ...
    document.getElementById('popupInput').style.display = input ? 'block' : 'none';
