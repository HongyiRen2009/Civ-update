...
const tech = [
    ...
    [
        ...
        },
        {
            name: 'Workshop',
            description:
                'Unlock the blueprints for a workshop that constantly gives you wisdom at the cost of resources',
            requires: [[1, 8]],
            cost: 1,
        ...
        },
        {
            name: 'Scouting',
            description:
                "Gain the ability to get an approximate estimate of attacking enemies' military strength",
            requires: [[1, 6]],
            cost: 1,
        ...
        },
        {
            name: 'Fishing',
            description:
                'Unlock the blueprints for a fishing hut</br>Must be on a river and produces varying amounts of food',
            requires: [
                [1, 1],
                [1, 3],
            ],
    ...
    [
        ...
        },
        {
            name: 'Fortress',
            description:
                'Unlock the blueprints for a massive building that gives high military power',
            requires: [[2, 5]],
        ...
        },
        {
            name: 'Temple',
            description:
                'Unlock the blueprints for a temple that increases your luck at a higher rate',
            requires: [[1, 7]],
            cost: 1,
            category: 'Virtue',
            image: 'images/techscroll.png',
    ...
    [
...

        {
            ...
            choosetext() {
                if (this.tier > 0) {
                    this.description = `Fortresses give +${Math.floor(
                        Math.max(0.4 / (this.tier + 1), 0.01) * 100
                    )}% military`;
                }
            },
            effect() {
        ...
        },
        {
            name: 'Trade School',
            description:
                'Unlock the blueprints for a Trade School that increases all production by 20%',
            requires: [
                [3, 1],
                [3, 2],
                [3, 3],
...
for (let i = 0; i < tech.length; i++) {
    ...
    for (let j = 0; j < tech[i].length; j++) {
        defreset[i].push(tech[i][j].description);
    }
}
